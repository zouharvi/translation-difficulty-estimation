...
class CommandA:
    ...
    models = {"CohereForAI/c4ai-command-a-03-2025"}
    ...
    def translate(
        ...
        """
        Translate the given sources using a Command A model.
        ...
        for lang in tqdm(target_languages, desc="Processing languages"):
            ...
            for i in tqdm(
                ...
                postprocessed_tranlsations = [
                    postprocess_translation(t) for t in decoded_translations
                ]

                translations[lang].extend(postprocessed_tranlsations)
